...
const aboutMeTextContent =
  "I am Badara a Front End developer and I created beautiful responsive websites with the best user experience.I do not talk much,just contact me.:)";
...
const last4Btns=[];
  for (let index = 6; index < gotoBtn.length; index++) {
    last4Btns.push(gotoBtn[index])

    for (let i = 0; i < last4Btns.length; i++) {
      last4Btns[i].style.display="none";
...
const showProjects = (project, i) => {
  setTimeout(() => {
    ...
    for (let index = 0; index < last4Btns.length; index++) {
      last4Btns[index].style.display="flex";
...
const hideProjects = (project, i) => {
  setTimeout(() => {
    project.style.display = "none";
     ...
     for (let index = 0; index < last4Btns.length; index++) {
       last4Btns[index].style.display = "none";
     }
